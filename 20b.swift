// This solution is too slow to find the ans for the whole input
// But I could the input data into 4 independent subgraphs
// Than I found the ans for each subgraph and calculated the LCM
